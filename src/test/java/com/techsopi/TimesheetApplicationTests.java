...
class TimesheetApplicationTests {
    ...
    public void givenClientObject_whenCreateClient_thenReturnSavedClient() throws Exception {
        ...
        ClientEntity client = ClientEntity.builder()
                ...
                .emailId("ronak.tinker@techsopi.com")
                .firstName("ronak")
                .lastName("tinker")
                .phone("9234567890")
                .mobile("9234567543")
    ...
    public void testGetClientById() {
        ...
        mockClient.setEmailId("aniska@techsopi.com");
        mockClient.setFirstName("aniska");
        mockClient.setLastName("singh");
        mockClient.setPhone("987723456");
        mockClient.setMobile("12345678");
        mockClient.setStreetAddress("asdfgh");
        mockClient.setCity("jaipur");
    ...
    void testGetClients() {
        List<ClientDTO> mockClients = Arrays.asList(
                new ClientDTO().clientId(1l)
                        ...
                        .emailId("prasant.kumar@techsopi.com")
                        .firstName("Prasant")
                        .lastName("kumar")
                        .phone("9102754328")
                        .mobile("8765432123")
